                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <form method="post" action="<?php echo e(url('admin/rooms')); ?>">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="rt_id" class="form-control">
                                                    ...
                                                    <option value="<?php echo e($rt->id); ?>"><?php echo e($rt->title); ?></option>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\int221\resources\views/room/create.blade.php ENDPATH**/ ?>